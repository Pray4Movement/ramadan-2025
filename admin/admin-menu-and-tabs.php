...
/**
 * Class Ramadan_2025_Menu
 */
class Ramadan_2025_Menu {

    public $token = 'ramadan_2025';
    public $page_title = 'Ramadan 2025';

    private static $_instance = null;

    /**
     * Ramadan_2025_Menu Instance
     *
     * Ensures only one instance of Ramadan_2025_Menu is loaded or can be loaded.
     *
     * @since 0.1.0
     * @static
     * @return Ramadan_2025_Menu instance
     */
    ...
    public function __construct() {
        ...
        $this->page_title = 'ramadan-2025';

        add_action( 'dt_prayer_campaigns_admin_install_fuel', [ 'Ramadan_2025_Tab_General', 'content' ] );
    } // End __construct()
}
Ramadan_2025_Menu::instance();

/**
 * Class Ramadan_2025_Tab_General
 */
class Ramadan_2025_Tab_General {
    ...
    public static function main_column() {
        ...
        <table class="widefat striped">
            <thead>
                <tr>
                    <th>Ramadan 2025 Prayer Fuel</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>
                        <p>
                            This is the prayer fuel created for the Ramadan 2025 campaign.
                        </p>
                        <p>
            ...
            jQuery(document).ready(function ($){
                ...
                $('#ramadan-install-form').on('submit', function (e){
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        url: "<?php echo esc_url( rest_url() ) ?>ramadan-2025/install",
                        beforeSend: (xhr) => {
                ...
                $('#confirm-ramadan-delete').on('click', function (){
                    ...
                    $.ajax({
                        ...
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
                        url: "<?php echo esc_url( rest_url() ) ?>ramadan-2025/delete",
                        beforeSend: (xhr) => {
                            xhr.setRequestHeader("X-WP-Nonce",'<?php echo esc_attr( wp_create_nonce( 'wp_rest' ) ) ?>');
                        },
                        data: JSON.stringify({
